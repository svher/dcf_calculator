...
# %% [code]
rule_label_dict = {
    1912: ['底线问题-品质差', '劣质/描述不符-商家'],
    1916: ['底线问题-品质差', '劣质/描述不符-商家'],
    1914: ['底线问题-品质差', '劣质/描述不符-商家'],
    223215:	['底线问题-品质差',	'出售文玩赝品-商家'],
    223216:	['底线问题-品质差',	'出售文玩赝品-商家'],
    223226:	['底线问题-品质差',	'出售文玩赝品-商家'],
    223228:	['底线问题-品质差',	'出售文玩赝品-商家'],
    222671:	['底线问题-品质差',	'抽检不合格-商家'],
    222673:	['底线问题-品质差',	'抽检不合格-商家'],
    222678:	['底线问题-品质差',	'抽检不合格-商家'],
    222977:	['底线问题-品质差',	'抽检不合格-商家'],
    223217:	['底线问题-品质差',	'出售文玩赝品-商家'],
    223225:	['底线问题-品质差',	'出售文玩赝品-商家'],
    222676:	['底线问题-品质差',	'抽检不合格-商家'],
    220733:	['底线问题-品质差',	'虚假宣传-商家']
}
...
for group_info in tqdm(group_output):
    ...
    recall_reason = '劣质种子扩散'
    seed_shop_group_type = '劣质'
...
# %% [code]
dataframe2hive(df=group_result_df, table_name='ecom_govern_community.groupaudit_shop_recallstrategy_v1_result_groupshopinfo', date=today, risk_type='lz', spark=spark)
